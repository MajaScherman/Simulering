...
public class MainSimulation extends Global {
	...
	public static void main(String[] args) throws IOException {
		...
		Dispatcher dispatcher = new Dispatcher(); // Q1, Q2, Q3, Q4, Q5);
		...
		Generator.lambda = 9; // Generator ska generera nio kunder per sekund
								// //Generator shall generate 9 customers per
								// second
		...
		System.out.println("Mean number of customers in queue1: " + 1.0 * Q1.accumulated / Q1.noMeasurements);
		System.out.println("Mean number of customers in queue2: " + 1.0 * Q2.accumulated / Q2.noMeasurements);
		System.out.println("Mean number of customers in queue3: " + 1.0 * Q3.accumulated / Q3.noMeasurements);
		System.out.println("Mean number of customers in queue4: " + 1.0 * Q4.accumulated / Q4.noMeasurements);
		System.out.println("Mean number of customers in queue5: " + 1.0 * Q5.accumulated / Q5.noMeasurements);
