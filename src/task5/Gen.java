...
class Gen extends Proc{
	...
	public double beta;  //Hur många per sekund som ska generas //How many to generate per second
	...
	public void TreatSignal(Signal x){
		switch (x.signalType){
			case READY:{
				...
				SignalList.SendSignal(READY, this, time + (2.0*beta)*slump.nextDouble());}
				break;
		}
	}
}