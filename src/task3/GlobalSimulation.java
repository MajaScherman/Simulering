...
public class GlobalSimulation{
	...
	public static final int ARRIVAL = 1, DEPARTURE_FROM_1 = 2, DEPARTURE_FROM_2 = 3, MEASURE = 4; // The events, add or remove if needed!
	...
	public static void insertEvent(int type, double TimeOfEvent, double aTime){  // Just to be able to skip dot notation
		eventList.InsertEvent(type, TimeOfEvent, aTime);
	}
}